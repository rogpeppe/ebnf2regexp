...
type (
	...
	// A Complement node represents the complement of a set
	// of single characters.
	Complement struct {
		Not  scanner.Position
...
func (x *Complement) Pos() scanner.Position { return x.Not }
